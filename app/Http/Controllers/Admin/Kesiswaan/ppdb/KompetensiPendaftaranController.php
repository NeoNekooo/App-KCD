...
class KompetensiPendaftaranController extends Controller
{
    public function index()
    {
        ...
        return view('admin.kesiswaan.ppdb.kompetensi_pendaftaran', compact('kompetensiPendaftaran', 'tahunPpdb'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.kesiswaan.ppdb.kompetensi-ppdb.index')
