        ...
        <div class="modal-body">
          <div class="row g-6 mb-3">
            <div class="col">
              ...
              <input type="text" name="tahun_pelajaran" id="tahunPelajaran" class="form-control" placeholder="2025/2026" required>
            </div>
          </div>
          <div class="row g-6 mb-3">
            <div class="col">
              <label for="keterangan" class="form-label">Keterangan</label>
              <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Misal: Tahun ajaran baru"></textarea>
            </div>
          </div>
        </div>
    ...
    <div class="modal-content">
      <form id="formEdit" method="POST">
        ...
        <div class="modal-body">
          <div class="row g-6 mb-3">
            <div class="col">
              <label for="editTahun" class="form-label">Tahun Pelajaran</label>
              <input type="text" name="tahun_pelajaran" id="editTahun" class="form-control" required>
            </div>
          </div>
          <div class="row g-6 mb-3">
            <div class="col">
