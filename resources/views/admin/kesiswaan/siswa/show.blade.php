...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
   ...
   class="btn btn-primary btn-sm shadow-sm">
    <i class="bx bxs-file-pdf me-1"></i> Cetak Semua ({{ $siswas->count() }})
            ...
            {{-- TOMBOL BIODATA PDF (SATUAN - DINAMIS VIA JS) --}}
            <a href="{{ route('admin.kesiswaan.siswa.cetak_pdf', $siswas->first()->id) }}" target="_blank" class="btn btn-danger btn-sm shadow-sm" id="header-btn-pdf">
                <i class="bx bxs-file-pdf me-1"></i> Cetak 1 tampil
            </a>

            {{-- TOMBOL KARTU PELAJAR (SATUAN - DINAMIS VIA JS) --}}
            ...
            <div class="card-body p-0">
                <div class="row g-0">
                    ...
                    <div class="col-lg-9 p-4 d-flex flex-column bg-white">
                        ...
                        <form action="{{ route('admin.kesiswaan.siswa.update', $siswa->id) }}" method="POST" id="form-siswa-{{ $siswa->id }}">
                            @csrf @method('PUT')
