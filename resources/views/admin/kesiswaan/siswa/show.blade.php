                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-auto text-center text-md-start">
                            <div class="position-relative d-inline-block">
                                <div class="avatar-profile rounded-3 shadow-sm" style="width: 150px; height: 180px; overflow: hidden; border: 3px solid #fff;">
                                    <img src="{{ $siswa->foto_url }}" alt="" class="w-100 h-100" 
