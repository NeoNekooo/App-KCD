                ...
                <div class="card-body position-relative pt-0 pb-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-auto text-center text-md-start">
                            <div class="avatar-profile rounded-3 mx-auto mx-md-0 d-flex align-items-center justify-content-center p-1">
                                <img src="{{ $siswa->foto_url }}" alt="" class="rounded-3 shadow-sm w-100 h-100" 
