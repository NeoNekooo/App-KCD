...
@section('content')
    ...
    {{-- =================================================================== --}}
    {{-- SECTION 1: HERO HEADER (JAM + LOGIC HIDE WILAYAH)                   --}}
    {{-- =================================================================== --}}
    <div class="row mb-4">
        <div class="col-12">
            <div class="card overflow-hidden border-0 shadow-sm" style="border-radius: 1rem;">
                <div class="card-body p-4 text-white"
                    ...
                    <div
                        ...
                        {{-- BAGIAN KANAN: JAM & STATISTIK --}}
                        <div class="d-flex flex-column flex-md-row align-items-center gap-4 text-center text-md-end">

                            {{-- 1. JAM REALTIME --}}
                            {{-- Jika Admin: Ada garis pembatas di kanan jam. Jika Pegawai: Tidak ada garis. --}}
                            ...
                            {{-- 2. STATISTIK KAB/KOTA & KECAMATAN (HANYA ADMIN) --}}
                            @if ($isAdmin)
    ...
    {{-- =================================================================== --}}
    {{-- SECTION 2: TAMPILAN KHUSUS ADMIN (Data Makro)                       --}}
    {{-- =================================================================== --}}
    @if ($isAdmin)
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="{{ route('admin.kesiswaan.siswa.index') }}"
                            ...
                            <div>
                                <h6 class="mb-0">Cari Data Siswa</h6><small class="text-muted">Pencarian Detail</small>
                            </div>
                        </a>
    ...
    {{-- =================================================================== --}}
    {{-- SECTION 3: TAMPILAN KHUSUS PEGAWAI (Workspace)                      --}}
    {{-- =================================================================== --}}
    @if ($isPegawai)
                ...
                <div class="card border-0 shadow-sm h-100 bg-white">
                    <div class="card-body p-5 text-center d-flex flex-column justify-content-center align-items-center">
                        ...
                        <p class="text-muted" style="max-width: 500px;">
                            ...
                            samping untuk memulai verifikasi dokumen pengajuan.
                        </p>

                        <div class="d-flex justify-content-center gap-3 mt-4">
                            {{-- Tombol Pintas ke Layanan Mutasi (Contoh) --}}
...
@push('styles')
    <style>
        ...
        /* CSS Khusus untuk Divider di Header */
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // -------------------------------------------------------
            // 2. CHART ADMIN (HANYA JIKA ADA ELEMENNYA / ADMIN ONLY)
            // -------------------------------------------------------
