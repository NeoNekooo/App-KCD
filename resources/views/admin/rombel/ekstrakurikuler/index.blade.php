    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('admin.rombel.ekstrakurikuler.store') }}">
                @csrf
                <div class="modal-body">
                    {{-- Input Nama Ekskul (Teks) --}}
                    <div class="mb-3">
                        <label class="form-label">Nama Ekstrakurikuler <span class="text-danger">*</span></label>
                        <input type="text" name="nama" class="form-control" placeholder="Contoh: Pramuka" required>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Nama Ekstrakurikuler <span class="text-danger">*</span></label>
                        <input type="text" name="nama" id="edit_nama" class="form-control" placeholder="Contoh: Pramuka" required>
                    </div>
...
<script>
    ...
    function editEkskul(button) {
        ...
        const masterName = button.dataset.masterName; // Nama dari tabel master
        ...
        // Set value ke input di modal
        document.getElementById('edit_nama').value = masterName || '';
