    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-wrap" style="max-width: 250px;">{{ $t->tugas_pokok }}</td>
                    ...
                    <div class="edit-sk-container" data-id="{{ $t->id }}">
                        ...
                        <div class="sk-input-group d-none" id="input-group-{{ $t->id }}">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" id="input-{{ $t->id }}"
                                       value="{{ $t->nomor_sk }}"
                                       onkeyup="if(event.key === 'Enter') saveSk('{{ $t->id }}')">
                ...
                <td>
                    <button class="btn btn-sm btn-icon btn-label-primary"
                            onclick="openCetakModal('{{ $t->id }}', '{{ $t->gtk->nama }}')">
