...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kepegawaian /</span> GTK Non-Aktif</h4>

<div class="card">
    <div class="card-header">
        <div class="d-flex align-items-center justify-content-between">
            <h5 class="card-title m-0 me-2">Daftar GTK Non-Aktif</h5>
            <div class="d-flex gap-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('admin.kepegawaian.gtk.inactive.export.excel', request()->query()) }}">Export Semua</a></li>
    ...
    <div class="card-body">
        <form action="{{ route('admin.kepegawaian.gtk.inactive') }}" method="GET">
        ...
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td><span class="badge bg-label-danger">{{ $gtk->status ?? 'Non-Aktif' }}</span></td>
                    <td>
    ...
    <div class="card-footer border-top">
        <div class="row align-items-center">
            <div class="col-md-6 d-flex align-items-center mb-2 mb-md-0">
                ...
                <form action="{{ route('admin.kepegawaian.gtk.inactive') }}" method="GET" class="d-inline-block">
                ...
                <span class="text-muted ms-2 small">
                    dari <strong>{{ $gtks->total() }}</strong> data
                </span>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (exportSelectedLink) {
            exportSelectedLink.addEventListener('click', function(e) {
                ...
                if (selectedIds) {
                    let url = `{{ route('admin.kepegawaian.gtk.inactive.export.excel') }}?ids=${selectedIds}`;
