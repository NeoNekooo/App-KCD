            ...
            <div class="card-body mt-4 pb-2">
                <form action="{{ route('admin.gtk.guru.index') }}" method="GET" id="filterForm">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('admin.gtk.guru.index') }}"
                        ...
                        <div class="col-12 mt-3">
                            <div class="filter-search-group d-flex align-items-center pe-1">
                                ...
                                <input type="text" id="searchInput" name="search" class="form-control px-3 py-2"
                                    placeholder="Cari Nama Guru, NIP, atau NUPTK..." value="{{ request('search') }}"
                                    autocomplete="off">
                                <button type="submit"
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="py-3 text-uppercase text-muted text-center"
                                    style="font-size: 0.75rem; font-weight: 700;">L/P</th>
                                <th class="py-3 text-uppercase text-muted" style="font-size: 0.75rem; font-weight: 700;">
                        ...
                        <tbody class="border-top-0">
                            @forelse ($gurus as $index => $gtk)
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-md me-3 flex-shrink-0">
                                                ...
                                                @else
                                                    ...
                                                    <div
                                                        class="avatar-initial rounded-circle bg-label-primary shadow-xs d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="d-flex flex-column text-truncate" style="max-width: 250px;">
                                                ...
                                                <small class="text-muted font-monospace" style="font-size: 0.75rem;">
                                                    ...
                                                    @elseif($gtk->nuptk && trim($gtk->nuptk) != '-')
                                                        <span class="text-info">NUPTK. {{ $gtk->nuptk }}</span>
                                                    @else
                                    ...
                                    <td class="text-center">
                                        <span
                                            class="fw-bold {{ $gtk->jenis_kelamin == 'L' ? 'text-info' : 'text-danger' }}">
                                    ...
                                    <td class="text-end pe-4">
                                        <a href="{{ route('admin.gtk.show', $gtk->id) }}"
                                            class="btn btn-sm btn-icon btn-label-primary rounded-circle shadow-none"
                                            data-bs-toggle="tooltip" title="Lihat Profil Guru">
                ...
                <div class="card-footer border-top bg-transparent py-3 px-4">
                    <div class="row align-items-center g-3">
                        <div class="col-md-6 d-flex align-items-center flex-wrap gap-2">
                            ...
                            <form action="{{ route('admin.gtk.guru.index') }}" method="GET"
                            ...
                            <span class="text-muted fw-semibold small ms-2 border-start ps-3">Total: <span
                                    class="text-dark">{{ $gurus->total() }}</span> Guru</span>
                        </div>
