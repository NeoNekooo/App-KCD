...
<style>
    ...
    .nav-custom .nav-link:hover:not(.active) { background-color: rgba(105, 108, 255, 0.05); color: #696cff; }
    .nav-custom .nav-link.active { 
        background-color: #696cff; color: #fff; 
    ...
    .icon-primary { background: rgba(105, 108, 255, 0.1); color: #696cff; }
    .icon-success { background: rgba(113, 221, 55, 0.1); color: #71dd37; }
...
<div class="flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-4 animate-fade-up">
        <span class="text-muted fw-light">GTK / <a href="{{ $backRoute }}" class="text-muted text-decoration-none">{{ $labelMenu }}</a> /</span> Profil Detail
    </h4>
                ...
                <div class="card-body position-relative pt-0 pb-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-auto text-center text-md-start">
                            <div class="avatar-profile rounded-circle mx-auto mx-md-0 d-flex align-items-center justify-content-center p-1 bg-white">
                                @php
                                ...
                                @else
                                    ...
                                    <span class="rounded-circle bg-label-primary fs-1 fw-bold text-uppercase w-100 h-100 d-flex align-items-center justify-content-center" style="font-size: 3.5rem !important;">
                        ...
                        <div class="col flex-grow-1 mt-3 mt-md-0 text-center text-md-start pt-md-3">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center align-items-md-start">
                                <div>
                                    ...
                                    <p class="mb-3 text-primary fw-semibold fs-6">{{ $gtk->jabatan_ptk_id_str ?? 'Tenaga Kependidikan' }}</p>
                                    ...
                                    <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-2">
                                        ...
                                        <span class="badge bg-label-{{ ($gtk->jenis_kelamin == 'L' || $gtk->jenis_kelamin == 'Laki-laki') ? 'dark' : 'danger' }} px-3 py-2 rounded-pill shadow-sm-custom">
                                ...
                                <div class="mt-4 mt-md-0">
                                    <a href="{{ $backRoute }}" class="btn btn-outline-secondary rounded-pill shadow-sm-custom px-4 fw-bold">
    ...
    <div class="row g-4 mb-4 animate-fade-up delay-2">
            ...
            <div class="card h-100 border-0 shadow-soft rounded-4 hover-lift">
                <div class="card-body d-flex justify-content-between align-items-center p-4">
                    <div class="overflow-hidden">
                        <span class="d-block text-uppercase fw-bold text-muted small mb-1" style="letter-spacing: 0.5px;">Status Pegawai</span>
                        <h5 class="mb-0 fw-bold text-dark text-truncate" title="{{ $gtk->status_kepegawaian_id_str }}">{{ $gtk->status_kepegawaian_id_str ?? '-' }}</h5>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card h-100 border-0 shadow-soft rounded-4 hover-lift">
                <div class="card-body d-flex justify-content-between align-items-center p-4">
                    <div class="overflow-hidden">
                        <span class="d-block text-uppercase fw-bold text-muted small mb-1" style="letter-spacing: 0.5px;">Pendidikan</span>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card h-100 border-0 shadow-soft rounded-4 hover-lift">
                <div class="card-body d-flex justify-content-between align-items-center p-4">
                    <div class="overflow-hidden">
                        <span class="d-block text-uppercase fw-bold text-muted small mb-1" style="letter-spacing: 0.5px;">Usia</span>
                        <h5 class="mb-0 fw-bold text-dark">
                            {{ $gtk->tanggal_lahir ? \Carbon\Carbon::parse($gtk->tanggal_lahir)->age . ' Tahun' : '-' }}
                        </h5>
                    </div>
                    <div class="icon-box" style="background: rgba(255, 171, 0, 0.1); color: #ffab00;"><i class="bx bx-cake"></i></div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-xl-3">
            <div class="card h-100 border-0 shadow-soft rounded-4 hover-lift">
                <div class="card-body d-flex justify-content-between align-items-center p-4">
                    <div class="overflow-hidden">
                        <span class="d-block text-uppercase fw-bold text-muted small mb-1" style="letter-spacing: 0.5px;">Masa Kerja</span>
                        <h5 class="mb-0 fw-bold text-dark">
                            {{ $gtk->tmt_pengangkatan ? \Carbon\Carbon::parse($gtk->tmt_pengangkatan)->diffForHumans(null, true) : '-' }}
                        </h5>
                    </div>
                    <div class="icon-box" style="background: rgba(0, 204, 221, 0.1); color: #00ccdd;"><i class="bx bx-time-five"></i></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-5 mb-4">
            <div class="card h-100 shadow-soft border-0 rounded-4">
                <div class="card-header pt-4 pb-3 border-bottom">
                    <h6 class="fw-bold mb-0 text-uppercase text-muted" style="letter-spacing: 0.5px;">Informasi Kontak</h6>
                </div>
                <div class="card-body pt-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="overflow-hidden">
                            ...
                            <span class="fw-semibold text-dark text-truncate d-block">{{ $gtk->email ?? 'Tidak tersedia' }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <span class="fw-semibold text-dark">{{ $gtk->no_hp ?? $gtk->no_telepon_rumah ?? 'Tidak tersedia' }}</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="overflow-hidden">
                            ...
                            <span class="fw-bold text-dark text-truncate d-block" title="{{ $gtk->sekolah->nama ?? '' }}">
                    ...
                    <div class="bg-lighter rounded-3 p-3">
                        <p class="mb-1 text-dark fw-medium"><i class='bx bx-map text-primary me-2'></i>{{ $gtk->alamat_jalan ?? 'Alamat belum diisi' }}</p>
                        @if($gtk->rt || $gtk->rw)
                        ...
                        @if($gtk->kabupaten_kota)
                            <p class="mb-0 ms-4 fw-semibold text-dark">{{ $gtk->kabupaten_kota ?? '' }} <span class="text-muted fw-normal">{{ $gtk->kode_pos ? '- '.$gtk->kode_pos : '' }}</span></p>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="card-header border-bottom pt-4 pb-3">
                    <ul class="nav nav-pills nav-custom" role="tablist">
                        ...
                        <li class="nav-item ms-2">
                            <button type="button" class="nav-link shadow-xs" role="tab" data-bs-toggle="tab" data-bs-target="#navs-kepegawaian">
                                ...
                                <table class="table table-borderless table-profile w-100 m-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value-td font-monospace text-primary">{{ $gtk->nik ?? '-' }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value-td">{{ $gtk->tanggal_lahir ? \Carbon\Carbon::parse($gtk->tanggal_lahir)->translatedFormat('d F Y') : '-' }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value-td">
                                                @if($gtk->status_perkawinan)
                                                    <span class="badge bg-label-secondary px-3 py-1">{{ $gtk->status_perkawinan }}</span>
                                                @else
                                                    -
                                                @endif
                                            </td>
                                ...
                                <table class="table table-borderless table-profile w-100 m-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="value-td"><span class="badge bg-label-info px-3 py-1">{{ $gtk->jenis_ptk_id_str ?? '-' }}</span></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value-td">{{ $gtk->tmt_pengangkatan ? \Carbon\Carbon::parse($gtk->tmt_pengangkatan)->translatedFormat('d F Y') : '-' }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value-td">
                                                {{ $gtk->sk_cpns ?? '-' }} 
                                                @if($gtk->tmt_cpns)
                                                    <br><small class="text-muted"><i class="bx bx-calendar text-primary me-1"></i>{{ \Carbon\Carbon::parse($gtk->tmt_cpns)->translatedFormat('d M Y') }}</small>
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label-td">Sumber Gaji</td>
                                            <td class="value-td"><span class="badge bg-label-success px-3 py-1">{{ $gtk->sumber_gaji ?? '-' }}</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
