...
@section('content')
{{-- 
    LOGIC PHP: Menentukan Label & Link Kembali secara dinamis 
    berdasarkan apakah jabatan mengandung kata "Guru" atau tidak.
--}}
@php
...
{{-- TANPA CONTAINER WRAPPER --}}

{{-- BREADCRUMB --}}
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">GTK / <a href="{{ $backRoute }}">{{ $labelMenu }}</a> /</span> Detail Profil
</h4>
            ...
            <div class="card-body position-relative pt-0">
                <div class="row">
                    ...
                    <div class="col-sm-auto text-center text-sm-start mt-n5">
                        <div class="d-flex justify-content-center justify-content-sm-start">
                            <div class="bg-white p-1 rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width: 140px; height: 140px;">
                                ...
                                @else
                                    <span class="avatar-initial rounded-circle bg-label-primary fs-1 fw-bold text-uppercase w-100 h-100 d-flex align-items-center justify-content-center" style="font-size: 3rem;">
                                        {{ substr($gtk->nama, 0, 2) }}
                                    </span>
                                @endif
                            </div>
                    ...
                    <div class="col flex-grow-1 mt-3 mt-sm-4 text-center text-sm-start">
                        ...
                        <p class="mb-2 text-muted fw-medium">{{ $gtk->jabatan_ptk_id_str ?? 'GTK' }}</p>
