            ...
            <div class="card-body py-4">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item px-0 pb-3 pt-0">
                        ...
                        @if($kepalaSekolah)
                            <div class="fw-bold text-dark">{{ $kepalaSekolah->nama }}</div>
                            @if(!empty($kepalaSekolah->nip))
                                <small class="text-muted d-block">NIP: {{ $kepalaSekolah->nip }}</small>
                            @endif
                        @else
                            <span class="text-muted fst-italic small">Data belum tersedia di sistem.</span>
                        @endif
                    </li>

                    <li class="list-group-item d-flex justify-content-between px-0 py-3"><span class="fw-semibold">NSS / NPSN:</span><span>{{ $sekolah->nss ?? '-' }} / {{ $sekolah->npsn }}</span></li>
