@php
    ...
    $isi     = $dataSambutan->isi_sambutan ?? 'Sambutan belum diisi.';
    ...
    <div class="container mx-auto px-6 lg:px-12 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="text-center lg:text-left space-y-6">
                ...
                {{-- Nama Kepala Sekolah dengan Animasi Garis --}}
                <div class="animate-element flex items-center gap-4 opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="300">
                ...
                {{-- Isi Sambutan dengan Animasi --}}
                <div class="animate-element prose prose-lg text-slate-600 leading-relaxed text-justify opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="450">
                    {!! nl2br(e($isi)) !!}
                </div>
            ...
            <div class="relative flex justify-center lg:justify-end">
                <div class="relative w-80 h-96 lg:h-full">
                    ...
                    {{-- Efek Foto Bertumpuk (Stacked Photos) --}}
    ...
    const observer = new IntersectionObserver((entries, observer) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                // Stop observing the section after animation has been triggered
