...
<style>
    ...
    /* Styling Konten Sambutan */
    .content-sambutan p {
        margin-bottom: 1.5rem;
        line-height: 1.8;
    }
    .content-sambutan ul, .content-sambutan ol {
        margin-bottom: 1.5rem;
        margin-left: 1.5rem;
    }
    .content-sambutan li {
...
@php
    ...
    $isi   = $sambutan->isi_sambutan ?? '<p>Mohon maaf, isi sambutan belum tersedia saat ini.</p>';
...
<section class="relative bg-gradient-to-br from-slate-50 to-blue-50 pt-32 pb-16 overflow-hidden">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-3xl mx-auto">
            ...
            <h1 class="animate-on-scroll text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-6 opacity-0 translate-y-8 transition-all duration-1000 ease-out">
                {{ $judul }}
            </h1>
            <div class="animate-on-scroll h-1.5 w-24 bg-gradient-to-r from-blue-400 to-blue-600 mx-auto rounded-full opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="200"></div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div class="lg:col-span-4">
                <div class="animate-on-scroll sticky top-32 opacity-0 translate-x-8 transition-all duration-1000 ease-out" data-delay="400">
                    ...
                    {{-- Informasi Tambahan --}}
                    <div class="mt-8 p-6 bg-blue-50 rounded-2xl border border-blue-100 text-center shadow-sm">
                        <i class='bx bxs-quote-alt-left text-3xl text-blue-400 mb-3'></i>
                        <p class="text-slate-600 text-sm italic font-medium leading-relaxed">
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="animate-on-scroll opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="600">
                    <p class="text-xl md:text-2xl text-slate-700 leading-relaxed font-light border-l-4 border-blue-500 pl-6 italic">
                        Assalamualaikum Warahmatullahi Wabarakatuh,<br>
                        Salam sejahtera bagi kita semua.
                    </p>
                </div>

                {{-- Isi Utama (DIPERBAIKI) --}}
                {{-- Menggunakan {!! $isi !!} agar tag HTML dirender --}}
                {{-- Class content-sambutan mengatur spacing antar paragraf --}}
                <article class="animate-on-scroll content-sambutan prose prose-lg prose-slate max-w-none text-slate-600 text-justify first-letter opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="800">
                    {!! $isi !!}
                </article>

                {{-- Penutup / Tanda Tangan --}}
                <div class="animate-on-scroll mt-16 pt-8 border-t border-slate-200 flex flex-col items-end opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="1000">
                    <p class="text-slate-500 mb-3 text-sm font-medium uppercase tracking-wider">Hormat Kami,</p>
                    <div class="text-right">
                        <h4 class="text-2xl font-bold text-slate-900 font-serif">{{ $nama }}</h4>
                        <p class="text-blue-600 text-sm font-semibold mt-1">Kepala Sekolah</p>
                    </div>
                </div>
...
{{-- QUOTE SECTION --}}
<section class="relative py-24 bg-slate-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="animate-on-scroll max-w-4xl mx-auto text-center opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="1200">
            <i class='bx bxs-quote-alt-left text-5xl text-blue-200 mb-6'></i>
            <blockquote class="text-2xl md:text-4xl font-serif font-bold text-slate-800 leading-relaxed">
...
<section class="animate-on-scroll relative bg-gradient-to-br from-blue-600 to-blue-800 py-20 overflow-hidden opacity-0 translate-y-8 transition-all duration-1000 ease-out" data-delay="1400">
    ...
    <div class="container mx-auto px-4 text-center relative z-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('ppdb.cek_status') }}" class="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-bold rounded-full shadow-xl transition-all duration-300 bg-white text-blue-700 hover:bg-slate-100 transform hover:-translate-y-1">
                <span class="relative flex items-center gap-2">
                    <i class='bx bxs-user-plus text-xl'></i>
                    Daftar SPMB Sekarang
                </span>
            </a>
            <a href="{{ route('home') }}" class="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-bold rounded-full border-2 border-white/30 text-white hover:bg-white/10 transition-all duration-300">
                <span class="relative flex items-center gap-2">
