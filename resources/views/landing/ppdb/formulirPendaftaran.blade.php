        ...
        <section id="daftar" class="py-20 bg-gray-100">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" data-aos="fade-up" data-aos-delay="100"
                ...
                <div class="w-full bg-white shadow-2xl rounded-xl p-6 sm:p-10 border border-gray-100">
                    ...
                    {{-- Logic penentuan ID langkah berdasarkan tingkat aktif --}}
                    @php
                        $isSmk = ($tingkatAktif->tingkat ?? 0) == 10;
                        $uploadStepId = $isSmk ? 4 : 3;
                        $finishStepId = $isSmk ? 5 : 4;
                    @endphp
                    ...
                    <form id="ppdb-form" 
                        ...
                        data-tingkat="{{ $tingkatAktif->tingkat ?? '' }}">
                        @csrf
                        ...
                        <div id="formContent" class="min-h-[350px] bg-neutral-light p-6 rounded-lg shadow-inner">
                            ...
                            <div id="step-1" class="form-step space-y-6">
                                ...
                                <p class="text-sm text-gray-500 pt-2 border-t border-gray-200">Data Orang Tua :</p>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="nama_ayah" class="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap Ayah <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="nama_ibu" class="block text-sm font-medium text-gray-700 mb-2">Nama Lengkap Ibu <span class="text-red-500">*</span></label>
                            ...
                            {{-- Step 3 hanya muncul jika tingkat aktif adalah 10 --}}
                            @if ($isSmk)
                                <div id="step-3" class="form-step space-y-6 hidden">
                                    ...
                                    <div>
                                        <label for="jurusan" class="block text-sm font-medium text-gray-700 mb-2">
                                            Pilihan Utama Jurusan <span class="text-red-500">*</span>
                                        </label>
                                    ...
                                    <p class="text-sm text-gray-500 pt-2 border-t border-gray-200">
                                        Memilih jurusan yang sesuai minat akan meningkatkan peluang karir Anda setelah lulus.
                                    </p>
                                </div>
                            @endif


                            {{-- Langkah 'Upload Persyaratan' kini menggunakan ID dinamis --}}
                            <div id="step-{{ $uploadStepId }}" class="form-step space-y-6 hidden">
                                <h2 class="text-2xl font-bold text-primary-blue mb-4">Langkah {{ $uploadStepId }}: Upload Persyaratan</h2>
                                <p class="text-gray-700 mb-6">Unggah semua dokumen persyaratan pendaftaran. Dokumen wajib ditandai <span class="text-red-500">*</span>.</p>
                            ...
                            {{-- Langkah 'Selesai' kini menggunakan ID dinamis --}}
                            <div id="step-{{ $finishStepId }}" class="form-step hidden">
                                <h2 class="text-2xl font-bold text-primary-blue mb-4">Langkah {{ $finishStepId }}: Selesai</h2>
